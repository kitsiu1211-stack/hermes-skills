...
用具体问题问，不用打分：
- 生成力：拿 rank 的几根，能把文章里每个具体现象倒回来吗？倒不回来的现象指缺一根
- 独立性：任意两根之间，找得到"一个动了另一个没动"的例子吗？
- 中文：有没有翻译腔/AI 八股句？读出声来卡不卡？
- 结构：有没有具体的人名、数字、原话、案例？

任何一条答"没有"，改到有，再交付。

### 外派独立 Evaluator（高价值产物必做）

- 用 delegate_task 起独立子 agent，上下文完全隔离，只看"最终产物 + 原始材料（文章全文/任务需求）"
